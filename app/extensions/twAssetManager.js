...
(function (Scratch) {
  ...
  const EXTENSION_VERSION = "2026-07-21";
  ...
  class AssetManagerExtension {
    ...
    requireTextAssetName(value) {
      ...
      if (name.includes(":")) throw new Error("Text asset name must not contain a colon.");
      return name;
    }
    clearAssetError() {
